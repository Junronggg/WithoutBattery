...
async function sendMessage() {
    ...
    addMessage("🤖 AI is thinking...", "ai-msg"); // placeholder while waiting
    try {
        const res = await fetch("http://localhost:5000/ask", {  // your Flask backend URL
            method: "POST",
            headers: {
        ...
        // Remove the "AI is thinking..." placeholder
        ...
        addMessage("⚠️ Error connecting to AI: " + err.message, "ai-msg");
    }
}
